      ...
      <div class="container"> 
        ...
        <div class="modal" v-show="showViewModal">
            <div class="modal-content">
                ...
                <div class="dataGroup">
                    <p>Quantity: {{specificItems.quantity}}</p>
                </div> 
                <div class="dataGroup">
                    <p>Description: {{specificItems.description}}</p>
                </div> 
                </data>
        </div>
        </div>
 ...
 export default {
  ...
  data() {
    return {
      ...
      perPage: 5,
      currentPage: 1,
      fields: ["id", "name","category.name", "price","quantity","actions"],
      products: [],
      categories:[],
  ...
  methods: {
    ...
    console.log("store user is login = product ",this.userStore.isLogin);
    ...
    addItems(){
      ...
      this.formData.category_id=foundItem.id;
    ...
    updateItem() {
      ...
      const categoryData=this.categories;
      const foundItem = categoryData.find(item => item.name === this.editSelectedCategories);
