  ...
  <div class="container-login100">
    <div class="wrap-login100">
      <form class="login100-form validate-form" @submit.prevent="validateForm">
        ...
        <div class="wrap-input100 validate-input"  data-validate="Enter new password" :class="passwordisEmpty ? 'alert-validate' : ''">
...
export default {
  ...
  data() {
    ...
    if(this.otpIsEmpty===false && this.passwordisEmpty===false)
    {
      this.submitRequest();
    }
      },
    ...
    this.showPass = !this.showPass;
       ...
       submitRequest(){    
        const verificationToken=this.userStore.verifiedToken;
         axios.post('/resetPassword', this.formData,  {
            headers: {
